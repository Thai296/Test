...
public class CreateDATUIValidationTest extends SeleniumTestAsSimpliciaUser {
    ...
    public static String sFileToImport = System.getProperty("user.dir") + File.separator + "src\\test\\resources\\datimport.zip";
...
//            homePage.openLeftNavigation();
            ...
            // Click Déclaration d'accident de travail -> Mes DATs
            //.wait
//            leftNavigationMenuPage.checkPresenceOfMenuOption("Déclaration d'accident de travail");
//            leftNavigationMenuPage.checkPresenceOfLeftNavigationMenuOption("Déclaration d'accident de travail");
//            leftNavigationMenuPage.clickExpandIconToOpenMenu("Déclaration d'accident de travail");
...
//            leftNavigationMenuPage.closeLeftNavigation();
          leftNavigationMenuPage.checkPresenceOfMenuOption("accident de travail");
          leftNavigationMenuPage.checkPresenceOfLeftNavigationMenuOption("accident de travail");
          leftNavigationMenuPage.clickExpandIconToOpenMenu("accident de travail");
          leftNavigationMenuPage.checkPresenceOfLeftNavigationMenuOption("Mes DATs");
          leftNavigationMenuPage.clickMenuItemInLeftNavigation("Mes DATs");
          leftNavigationMenuPage.closeLeftNavigation();
...
//                    cleanDAT();
    ...
    /**
     * Steps:
     * 1. Login the simplicia page
     * 2. Navigate to Mes DATs
     * 3. Create/Import a complete DAT with all mandatory fields.
     * 4. Send for lawyer review.
     * 5. Login as lawyer, review and validate the DAT.
     * 6. Login again with user and validate if DAT is reviewed.
     * 7. CleanUp the test case- Delete the imported DAT
     *
     * @throws Exception
     */
    @Test(enabled=true)
    ...
    public void dat_Test_05_Lawyer_Review() throws Exception {
        ...
        try {
            ...
            // import the file
            LOGGER.info("*** Step 3 Action: Import a complete DAT with all mandatory fields ***");
            datMainPage.importDATF(sFileToImport, DATMainPage.DAT_IMPORT_SUCCESS_MESSAGE);
            bDat = datMainPage.isDatPresentOnDashboard(sImportedDATNumeroSS);
            Assert.assertTrue(bDat, "DAT is imported successfully");
            ...
            // send for review
            LOGGER.info("*** Step 4 Action: Send for lawyer review ***");
...
//                        sleepSilently(10000);
    ...
    public void dat_Test_06_Submit_To_Health_Insurance() throws Exception {
        ...
        try {
            ...
            // create dat
            LOGGER.info("*** Step 3 Action: Search for the created DAT using numero SS ***");
    ...
    public void dat_Test_07_ConvertZip_To_XML_CREATE_DAT() throws Exception {
        ...
        try {
            ...
            LOGGER.info("datimport:");
            LOGGER.info(datXmlInputPath);
          ...
          /*  Path sourcePath = Paths.get(getResourcePath(""));
            ...
            listFilesInDir(downloadFilePath);
            File source = new File(downloadFilePath + File.separator + "dat.zip");
            ...
            LOGGER.info("datdownload:");
            LOGGER.info(datXmlOutputPath);
